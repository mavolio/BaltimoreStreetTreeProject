...
A <- 
  bmore_bnia |> 
  rename('Stocking (%)' = percent_filled) |> 
  ggplot() + 
  geom_sf(aes(fill = `Stocking (%)`)) + 
  scale_fill_distiller(palette = "YlGn", trans = "reverse") + theme_void(10) +
  # guides(fill = guide_legend(title = "Stocking (%)"))
  NULL
...
#   scale_fill_distiller(palette = "RdPu", trans = "reverse", breaks = seq(10, 55, 5)) + theme_void(10)+
#   guides(fill = guide_legend(title = "Mean DBH\n(small, cm)"))

D <-
  bmore_bnia |> 
  rename(`Mean DBH\n(small, cm)` = AvgDBH_smallmed) |> 
  ggplot() + 
  geom_sf(aes(fill = `Mean DBH\n(small, cm)`)) + 
...
#   scale_fill_distiller(palette = "Oranges", trans = "reverse", breaks = seq(10, 55, 5)) + theme_void(10) +
#   guides(fill = guide_legend(title = "Mean DBH\n(large, cm)"))

E <- 
  bmore_bnia |> 
  rename(`Mean DBH\n(large, cm)` = AvgDBH_large) |> 
  ggplot() + 
  geom_sf(aes(fill = `Mean DBH\n(large, cm)`)) + 
