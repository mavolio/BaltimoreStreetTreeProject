...
#    , AvgDBH_med      # Small Tree Average DBH no longer a thing
    ...
    , pct_9m2         # % of trees above threshold 
...
mods_bi <- 
  ...
  pivot_longer(cols = rare_rich : pct_9m2, names_to = 'dep', values_to = 'dep_value') |> 
...
mods_bi_slag <- 
  ...
  mutate(
    ...
    , pct_9m2_lag        = st_lag(pct_9m2        , nbs, wts)
  ) |> 
  st_drop_geometry() |> 
  select(CSA2020          # id
         # dep 
  ...
  pivot_longer(cols = PercBlk : vacant20, names_to = 'ind', values_to = 'ind_value') |> 
  pivot_longer(cols = rare_rich_lag : pct_9m2_lag, names_to = 'lag', values_to = 'lag_value') |> 
  pivot_longer(cols = rare_rich : pct_9m2, names_to = 'dep', values_to = 'dep_value') |> 
