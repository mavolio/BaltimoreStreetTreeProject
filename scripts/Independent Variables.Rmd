...
# Poverty - BNIA percent below poverty line
```{r}
Poverty <- 
...
#Education - percent of population 25 and over with a Bachelor's Degree or above
```{r}
Edu <- 
...
IndVar <- PercentAsian %>% 
  ...
  left_join(temperature_by_neigh, by = "CSA2010")
