...
Dependent_pair <- read_csv('input_data/Dependent_variable_2025-03-14.csv') |> 
  drop_na()

Independent_pair <- read_csv('input_data/Independent_variable_2025-03-14.csv') |>  
  drop_na()
...
# ggsave( filename = paste0('figures/Figure_S1_socioenv_', Sys.Date(), '.png')
#        , width = 6
#        , height = 7)
