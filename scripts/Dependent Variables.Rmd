...
ggplot( most_common_species, aes(x = TreeSpecies, y = Count, fill = CSA2020)) +
...
madison_filtered <- small_species_abund %>% 
  filter(CSA2020 == "Madison/East End") 
...
patterson_filtered <- small_species_abund %>% 
  filter(CSA2020 == "Patterson Park North & East") 
