...
Independent<- read_csv('../input_data/Independent_variable_2025-03-05.csv')

# # Dexter path this is hopefully no longer necessary
...
small_dbh_r <- p_filtered_0.05 %>% 
  filter(Variable1 == "AvgDBH_small" | Variable2 == "AvgDBH_small")
